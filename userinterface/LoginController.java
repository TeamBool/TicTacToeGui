    ...
    public void Login(ActionEvent event) {
        try {
            ...
            if (database.loginUser(txtusername.getText(), txtpassword.getText())) {
                Userinterface.playerName = txtusername.getText();
                Userinterface.playerID = database.getID(txtusername.getText());
                isConnected.setText("Login erfolgreich");
                Userinterface.clientConnection.sendLogin(Userinterface.playerName, Userinterface.playerID);
